...
import type { AgentMessage, MessageRenderer } from "@yolziii/piii-web-ui";
import { defaultConvertToLlm, registerMessageRenderer } from "@yolziii/piii-web-ui";
...
declare module "@yolziii/piii-agent-core" {
