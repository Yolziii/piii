...
import type { EditorTheme, MarkdownTheme, SelectListTheme } from "@yolziii/piii-tui";
...
const THEME_KEY = Symbol.for("@yolziii/piii-coding-agent:theme");
...
export function getSettingsListTheme(): import("@yolziii/piii-tui").SettingsListTheme {
	return {
