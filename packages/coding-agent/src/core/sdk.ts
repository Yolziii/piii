...
import { Agent, type AgentMessage, type ThinkingLevel } from "@yolziii/piii-agent-core";
import type { Message, Model } from "@yolziii/piii-ai";
 ...
 *
 * // With explicit model
 * import { getModel } from '@yolziii/piii-ai';
 * const { session } = await createAgentSession({
